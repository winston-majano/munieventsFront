<template>
  <div class="col-md-12 mb-4" v-if="events">
    <div class="card">
      ...
      <div class="fecha">
        <p class="card-text_start">Fecha inicio: <br>{{ events.start_date }}</p>
        <p class="card-text_end">Fecha final: <br>{{ events.end_date }}</p>
      </div>
      <div class="card-body">
        <p class="card-text">{{ events.description }}</p>
        <div class="desc">
          <p class="card-text-ub"><strong>🗺:</strong>  {{ events.location }}</p>
