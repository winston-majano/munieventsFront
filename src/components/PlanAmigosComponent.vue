<template>
    <div class="col-lg-4 col-sm-4 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s"
        data-wow-offset="0">
        <div class="single-pricing single-pricing-white" v-for="plans in PlanAmigos" :key="plans.id">
            ...
            <ul>
                ...
                <li>Con cancelación antes de 24h</li>
                <li>50% más de monedas</li>
...
fetch('http://localhost:8080/api/v1/plans')
    ...
    .then(data => {
        ...
        PlanAmigos.value = data.filter(plan => plan.description === 'Plán Mejores Amigos');
    });
